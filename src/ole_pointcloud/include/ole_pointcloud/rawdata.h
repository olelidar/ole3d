...
#include <ole_pointcloud/calibration.h>
#include <ole_pointcloud/datacontainerbase.h>

namespace ole_rawdata
{
/**
 * Raw ole packet constants and structures.
 */
...
/** \brief ole data conversion class */
class RawData
{
public:
  RawData();
   ...
   */
  boost::optional<ole_pointcloud::Calibration> setup(ros::NodeHandle private_nh);
...
private:
   ...
   * Calibration file
   */
  ole_pointcloud::Calibration calibration_;
...
#endif  // ole_pointcloud_RAWDATA_H
